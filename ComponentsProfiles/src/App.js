...
const App = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfiles = async () => {
      try {
        const data = [
          { id: 1, name: 'Perfil 1', image: '/perfil1.png' },
          { id: 2, name: 'Perfil 2', image: '/perfil2.png' },
          { id: 2, name: 'Perfil 3', image: '/perfil3.png' },
          { id: 2, name: 'Perfil 4', image: '/perfil4.png' },
          { id: 2, name: 'Perfil 5', image: '/perfil5.png' },
        ];
        setProfiles(data);
      } catch (error) {
